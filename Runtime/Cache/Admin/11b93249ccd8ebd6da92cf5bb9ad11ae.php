...
<head>
    ...
    <link href="/tk/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/tk/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/tk/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/tk/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/tk/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/tk/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/tk/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/tk/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/tk/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script type="text/javascript" src="/tk/Public/static/uploadify/jquery.uploadify.min.js"></script>
...
<div class="tab-wrap">
            ...
            <?php if(is_array($fields[$key])): $i = 0; $__LIST__ = $fields[$key];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$field): $mod = ($i % 2 );++$i; if($field['is_show'] == 1 || $field['is_show'] == 3): ?><div class="form-item cf">
                    ...
                    <div class="controls">
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-medium" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                            ...
                            <?php case "datetime": ?><input type="text" name="<?php echo ($field["name"]); ?>" class="text input-large time" value="<?php echo (date('Y-m-d H:i',$data[$field['name']])); ?>" placeholder="请选择时间" /><?php break;?>
                            ...
                            <?php case "picture": ?><div class="controls">
									...
									<?php if(!empty($data[$field['name']])): ?><div class="upload-pre-item"><img src="/tk<?php echo (get_cover($data[$field['name']],'path')); ?>"/></div><?php endif; ?>
									</div>
								</div>
								...
								$("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
							        "height"          : 30,
							        "swf"             : "/tk/Public/static/uploadify/uploadify.swf",
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/tk", //当前网站地址
            "APP"    : "/tk/index.php?s=", //当前项目地址
            "PUBLIC" : "/tk/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/tk/Public/static/think.js"></script>
    <script type="text/javascript" src="/tk/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/tk/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/tk/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/tk/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/tk/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/tk/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
